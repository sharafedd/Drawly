...
public class CommentResource {
    ...
    public ResponseEntity<Comment> partialUpdateComment(
        ...
        Optional<Comment> result = commentRepository
            ...
            .map(existingComment -> {
                if (comment.getLinkedPost() != null) {
                    existingComment.setLinkedPost(comment.getLinkedPost());
                }
                if (comment.getLinkedUser() != null) {
                    existingComment.setLinkedUser(comment.getLinkedUser());
                }
